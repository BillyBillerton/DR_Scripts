...
#% Version 4.06
     ...
     var crossbow none
     var crossbow-ammo quad
     var crossbow-shoot poach
     var crossbow-snapshots off
     var bow composite bow
     var bow-ammo stone-tipped arrow
     var bow-shoot snipe
     ...
     var alwayshideFORranged on

     var targetmagic on
     var TM-spell-1 stra 10
     var TM-spell-2 none
     var TM-spell-3 none
     var TM-weapon none

     var debilitation on
     var debil-spell vs 15
     var debil-cast area
...
#% These are 'if not mind locked by this many attacks move on to next skill' defaults.
     ...
     var smalledge-attack-limit 30
     var largeedge-attack-limit 30
     var twohandededge-attack-limit 30
     var smallblunt-attack-limit 30
     var largeblunt-attack-limit 30
     var twohandedblunt-attack-limit 30
     var staves-attack-limit 30
     ...
     var brawl-attack-limit 30
     var TM-attack-limit 30
...
#% LOOT
     ...
     var box-holders backpack|duffel bag|haversack
     var box-limit 45

#% STANCES  EVA PARRY SHIELD ATTACK

     var change-stance off
     var smalledge-stance 100 20 65 100
     var largeedge-stance 69 60 60 100
     var twohandededge-stance 69 60 60 100
     var smallblunt-stance 100 20 65 100
     ...
     var bow-stance 70 70 52 100
     var slings-stance 89 00 100 100
     var lightthrown-stance 100 0 85 100
     var heavythrown-stance 69 60 60 100
     var offhand-stance 50 50 50 100
     var brawl-stance 100 0 85 100
     var TM-stance 100 0 85 100
...
#% SPELL BUFFS
     var buff-spell-1 c 23
     var buff-camb-1 5
     var buff-spell-2 sott 25
     var buff-camb-2 0
     var buff-spell-3 stw
     var buff-camb-3 0
...
#% CONTAINERS
     var sheath-1-name backpack
     var sheath-1-weapons greataxe|broadsword|throwing axe|scimitar
     var sheath-2-name none
     var sheath-2-weapons none
     var sheath-3-name none
     var sheath-3-weapons none
     var worn-weapons longbow|longbow
...
necrohealcheck:
     ...
     pause
put heal
     matchre necro-selfheal.set (left arm|right arm|left eye|right eye|head|neck|abdomen|chest|left hand|right hand|left leg|right leg|back|twitching\.)
