...
disarm_id:
	counter set 0
	matchre dquick is a trivially constructed|will be a simple matter for you to|should not take long with your skills|blindfold
	...
	matchre dtoss Prayer would be a good start|You could just jump off a cliff|same shot as a snowball|pitiful snowball encased in the Flames
...
lock_id:
	...
	matchre pquick is a trivially constructed|will be a simple matter for you to|should not take long with your skills|you could do it blindfolded!
...
dismantle:
	matchre container_check1 Roundtime
