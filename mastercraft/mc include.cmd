...
#the default settings
	 ...
	 var outfitting.storage canvas sack
...
location.vars:
	...
	#Crossing Outfitting
	 var CO.room.list 27|25|26|28|31|32|33|34|35|36|29|37|38|30|39|40
	 var CO.master.room 27|25|26|28|31|32|29|30
	 var CO.work.room 39|40|38|37|36|35|34|33
	 var CO.wheel.room 33|34|35
	 var CO.loom.room 36|37|38
...
check.location: 
	...
	if "$zoneid" = "1k" && contains("%CF.room.list", "$roomid") then var society Crossing.Forging
	if "$zoneid" = "1k" && contains("%CO.room.list", "$roomid") then var society Crossing.Outfitting
	if "$zoneid" = "1k" && contains("%CE.room.list", "$roomid") then var society Crossing.Engineering
