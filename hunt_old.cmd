...
SNIPE:
SNIPING:
	if contains("Necromancer|Ranger|Thief", "%guild") then return
	if ("%GAG_ECHO" != "YES") then
	{
		echo
		echo *** SNIPE: ***
...
WEAPON_CHECK:
	...
	LE:
		...
		if matchre("$righthandnoun", "dao|falcata|jambiya|kanabu|katar|knife|kounmya|kris|kythe|nehlata|oben|sword|tago|uenlata|hawkbill") then goto LE_SLICE
		goto WEAPON_APPR_ERROR
...
COMBAT_COMMAND:
	...
	if (("$avalanche" = "off") && ("%guild" = "Barbarian")) then put berserk ava
	pause .5
	pause .5
