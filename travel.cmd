########################################################
#Edited by the player of Isharon to work with Skills 3.0
#replaced climbing and swimming skill checks with athletics
########################################################
...
# -- Updated for DragonRealms 3.0 by Isharon
...
# -- https://elanthipedia.play.net/mediawiki/index.php/Travel_%28script%29
...
CANTSWIM3:
ECHO
ECHO *** YOU DO NOT HAVE ENOUGH ATHLETICS FOR THE FALDESU (140 ranks)
ECHO *** TAKING THE FERRY
ECHO
goto MONEYCHECK3
...
put .wd 50
waitfor SCRIPT DONE
put exchange 5 bronze kronar to lirum
pause
put exchange 5 bronze kronar to lirum
move out
move s
...
ECHO
pause
match LEAVEBARGEWEST The sand barge pulls into dock and
...
ECHO
pause 90
waitfor The sand barge pulls into dock and
pause
...
ECHO ===================
ECHO *** STONE CLAN AKA STAAN STOK (in Dwarven Haakish)
ECHO * * * Led by the clan elder, Buttcrest
...
ECHO * * * Built first by Elothean Corik the Black Butt and Queen Morganae of the Mountain Elves
...
match ALLFERRYMuspari The sand barge pulls into dock and
