...
action goto FALLEN_OVER when ^Running heedlessly over the rough terrain
action goto movingstart when ^You can't go there.
...
echo
echo USAGE - Choose to run from menu or directly from command bar 
echo 
...
echo
echo 3:	-- Zoluren --		Leth Deriel and Ilaya Taipa
echo
...
echo
echo ****************************************************************
echo 				Ilaya Taipa,  Areas
echo ****************************************************************
echo 	60 - Bank (Deposit Only)
echo 	61 - Fur Buyer
echo 	62 - Gem Shop
echo
echo Enter Location Number
...
echo ***************************************************************
echo 	50 - Swamp Trolls 			55 - Shamans, Rams, Eels
echo 	51 - Serpants and Vipers		56 - Dusk Ogres, Wolf Spiders
echo 	52 - Wildland Goblins 			57 - Young Ogres, Scount Ogres
echo 	53 - Goblin Zombies 			58 - Arbelogs 
echo 	54 - Nightstalker Unyn, Thoat Moda	59 - Barghest
echo **************************************************************
echo 				Throne City
echo ***************************************************************
...
if "%finaldirection" = "262" then setvar direction NORTH_ROAD_FERRY_TO_RIVER
...
if "%finaldirection" = "360" then setvar direction Illya_Taipa_BANK
if "%finaldirection" = "361" then setvar direction Illya_Taipa_TANNER
if "%finaldirection" = "362" then setvar direction Illya_Taipa_GEM_SHOP
...
MOVE_NORTH_ROAD_FERRY_TO_RIVER:
Setvar storeroomnumber 131
setvar waitingroom North Road, Ferry
if "$zoneid" = "7c" and "$roomid" = "%storeroomnumber" then goto CROSSINGFERRYNORTH
if "$zoneid" = "7c" then gosub move_final
if "$zoneid" != "7c" then gosub MOVE_NORTH_TRADE_ROUTE_TO_FERRY_SIDE
goto MOVE_NORTH_ROAD_FERRY_TO_RIVER
...
MOVE_Illya_Taipa_BANK:
Setvar storeroomnumber 102
setvar waitingroom Ilaya Taipa, Trader Outpost Bank
if "$zoneid" = "112" and "$roomid" = "%storeroomnumber" then gosub YOU_HAVE_ARRIVED
if "$zoneid" = "112" then gosub MOVE_FINAL
if "$zoneid" != "112" then gosub MOVE_TO_Illya_Taipa
goto MOVE_Illya_Taipa_BANK

MOVE_Illya_Taipa_TANNER:
Setvar storeroomnumber 99
setvar waitingroom Ilaya Taipa, Trader Outpost Furrier
if "$zoneid" = "112" and "$roomid" = "%storeroomnumber" then gosub YOU_HAVE_ARRIVED
if "$zoneid" = "112" then gosub MOVE_FINAL
if "$zoneid" != "112" then gosub MOVE_TO_Illya_Taipa
goto MOVE_Illya_Taipa_TANNER

MOVE_Illya_Taipa_GEM_SHOP:
Setvar storeroomnumber 100
setvar waitingroom Ilaya Taipa, Trader Outpost Gem Buyer
if "$zoneid" = "112" and "$roomid" = "%storeroomnumber" then gosub YOU_HAVE_ARRIVED
if "$zoneid" = "112" then gosub MOVE_FINAL
if "$zoneid" != "112" then gosub MOVE_TO_Illya_Taipa
goto MOVE_Illya_Taipa_GEM_SHOP
...
if "$zoneid" = "35" then goto MOVE_THRONE_DOCK
...
if "$zoneid" = "112" then goto MOVE_ILAYA_TAIPA_NORTHEAST_OUTOFTOWN
...
if "$zoneid" = "42" then goto MOVE_THEREN_MAIN_GATE_INTOWN
if "$zoneid" = "60" then goto MOVE_LETH_NORTHWEST_GATE_OUTOFTOWN
if "$zoneid" = "61" then goto MOVE_Illaya_Taipa_THROUGH_LETH
if "$zoneid" = "62" then goto MOVE_LETH_SOUTHWEST_GATE_OUTOFTOWN
if "$zoneid" = "66" then goto SOUTH-PLATFORM
if "$zoneid" = "67" then goto MOVE_SHARD_EAST_GATE_INTOWN
if "$zoneid" = "68" then goto MOVE_SHARD_SOUTH_GATE_OUTOFTOWN
if "$zoneid" = "69" then goto MOVE_SHARD_WEST_GATE_OUTOFTOWN
if "$zoneid" = "112" then goto MOVE_FINAL
return
...
if "$zoneid" = "35" then goto MOVE_THRONE_DOCK
if "$zoneid" = "40" then goto move_to_theren_outoftown
if "$zoneid" = "41" then goto MOVE_FINAL
if "$zoneid" = "42" then goto MOVE_CHECK_PASSPORT
if "$zoneid" = "60" then goto MOVE_LETH_NORTHWEST_GATE_TO_CROSSING_FERRY
if "$zoneid" = "61" then goto MOVE_LETH_SOUTHWEST_GATE_INTOWN
if "$zoneid" = "62" then goto MOVE_LETH_NORTHWEST_GATE_OUTOFTOWN
if "$zoneid" = "66" then goto SOUTH-PLATFORM
...
MOVE_ILAYA_TAIPA_NORTHEAST_OUTOFTOWN:
pause
put #goto 232
waitfor Stalks of spiny bladebrush growing along the roadside
pause
return


MOVE_Illaya_Taipa_THROUGH_LETH:
pause
put #goto 127
waitfor Old Crank's Road, Forest
pause
return
...
pause
put #goto 115
waitfor While pondering the fantastic variety of flora here
return
...
pause
put #goto 102
waitforre Smooth flagstones line the dusky-red soil of the road.|Patches of night shadow the flagstones of the road
put #goto 18
waitfor Leth Deriel, Sana'ati Dyaus Drui'tas
return 
...
if "%group" = "NO" then goto MOVE_NTR2_MOVE_TO_NTR1
...
matchre MOVE_NTR2_MOVE_TO_NTR1 You nod.
matchwait
...
if $roomid > 56 then goto MOVE_FERRY_MAIN
pause
put #goto 56
waitforre As the road crosses a low point between|You easily navigate the mud and move forward...
goto GROUP_CHECK_START_FERRY
...
waitfor Overall state of mind
	matchre PERCEPTIONCHECK01B head
	matchre PERCEPTIONCHECK01A Encumbrance :
...
BURDENCHECK01:
	...
	matchre BURDENCHECK01B Encumbrance : Somewhat
	matchre BURDENCHECK01C Encumbrance : Burdened
	matchre BURDENCHECK01D Encumbrance : Heavy
	matchre BURDENCHECK01E Encumbrance : Very Heavy
	matchre BURDENCHECK01F Encumbrance : Overburdened
	matchre BURDENCHECK01G Encumbrance : Tottering
	matchre BURDENCHECK01H even able to move?
	matchre BURDENCHECK01I amazing you aren't squashed!
put encumbrance
matchwait
...
MOVE_CHECK_PASSPORT:
if "%passport" = "yes" then goto MOVE_TO_MAURADERS
...
pause
put #goto 145
waitfor Ibec Hall, Passport Office
